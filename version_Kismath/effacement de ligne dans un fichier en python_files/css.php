...
.bbcode_container .bbcode_quote_container {
	background: transparent url(https://forum.developpez.be/images/misc/quote-left.png) no-repeat  left;
	display:block;
	width: 9px;
	height: 13px;
	position: absolute;
...
.previewthumbactive {
	position: absolute;
	background: url('https://forum.developpez.be/images/misc/pencil.png') no-repeat top left;
	cursor: pointer;
...
.cke_skin_kama span:not(.cke_browser_ie) .cke_button .cke_icon {
	background: url('https://forum.developpez.be/images/editor/sprite.png') no-repeat top left;
}
...
.memberaction_body.popupbody li .siteicon_profile { 
	background:url(https://forum.developpez.be/images/site_icons/profile.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_forum { 
	background:url(https://forum.developpez.be/images/site_icons/forum.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_message { 
	background:url(https://forum.developpez.be/images/site_icons/message.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_blog { 
	background:url(https://forum.developpez.be/images/site_icons/blog.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_homepage { 
	background:url(https://forum.developpez.be/images/site_icons/homepage.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_article { 
	background:url(https://forum.developpez.be/images/site_icons/article.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_add { 
	background:url(https://forum.developpez.be/images/site_icons/add.png) left 2px no-repeat; 
}
.memberaction_body.popupbody li .siteicon_email { 
	background:url(https://forum.developpez.be/images/site_icons/email.png) left 2px no-repeat; 
}
...
.pagination span a.popupctrl {
	height: 15.99px;
	background: #f2f6f8 url(https://forum.developpez.be/images/misc/black_downward_arrow.png) no-repeat center left;
	padding-right: 4px;
	padding-left: 18px;
}
...
.navpopupmenu .popupctrl .ctrlcontainer {
	background: transparent url(https://forum.developpez.be/images/misc/black_downward_arrow.png) no-repeat center left;
	padding-left: 15px;
	white-space:nowrap;
}
...
.navtabs > ul.floatcontainer li a.popupctrl {
	...
	background:transparent url(https://forum.developpez.be/images/misc/arrow.png) no-repeat right center;
	padding-right:15px;
	color: rgb(255, 255, 255);
}
...
.toplinks .notifications a.popupctrl {	
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #7192A8 url(https://forum.developpez.be/images/misc/arrow.png) right center no-repeat ;
	-moz-border-radius-bottomleft: 5px;
	-moz-border-radius-bottomright: 5px;
	-webkit-border-bottom-right-radius:5px;
	-webkit-border-bottom-left-radius: 5px;
...
.toplinks .notifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl.active , .toplinks .notifications a.popupctrl.active{
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #7192A8 url(https://forum.developpez.be/images/misc/arrow.png) no-repeat right center;
}
...
.breadcrumb .navbit {
	float:left;
	background-image:url(https://forum.developpez.be/images/misc/navbit-arrow-right.png);
	background-position:right center;
	background-repeat:no-repeat;
	padding-right:10px;
	padding-left:3px;
...
.formcontrols .blockrow select.rating option {
	background-image:url(https://forum.developpez.be/images/rating/rating-15_3.png);
	background-repeat:no-repeat;
